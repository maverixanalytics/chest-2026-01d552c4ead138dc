...
def render_sw(pages):
    ...
    # names alone means a changed icon, stylesheet or page ships with the same
    # VERSION, the service worker never invalidates, and reps keep the old copy
    # until they clear site data - which nobody does mid-conference.
...
self.addEventListener('fetch',function(e){{
  ...
  if(url.origin===location.origin){{                    // css, fonts, icons
